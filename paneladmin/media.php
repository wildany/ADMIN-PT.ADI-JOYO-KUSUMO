...
<body>
  <section id="container">
    ...
    <section id="main-content">
      ...
      if(empty($_GET['p']) OR $_GET['p'] == NULL) {
        include "content.php";
      }
      elseif(!empty($_GET['p']) && $_GET['p'] == 'daftarproduk') {
          include('advanced_table.php');
      }
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <div class="credits">
          <!--
            You are NOT allowed to delete the credit linkf to TemplateMag with free version.
